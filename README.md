...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,259 | 🐛 32 | 🌐 C | 📅 2026-08-24 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [vkQuake2](https://github.com/kondrak/vkQuake2) ⭐ 1,007 | 🐛 1 | 🌐 C | 📅 2026-08-04 - id Software's Quake 2 v3.21 with Vulkan support (Windows and Linux). \[GPL]
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 816 | 🐛 1,005 | 🌐 C++ | 📅 2026-08-25 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 816 | 🐛 1,005 | 🌐 C++ | 📅 2026-08-25. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 816 | 🐛 1,005 | 🌐 C++ | 📅 2026-08-25 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,126 | 🐛 19 | 🌐 GLSL | 📅 2026-08-18 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
...
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,259 | 🐛 32 | 🌐 C | 📅 2026-08-24.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,863 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-23 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,904 | 🐛 50 | 🌐 C++ | 📅 2026-08-26, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,904 | 🐛 50 | 🌐 C++ | 📅 2026-08-26. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,745 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-25 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,477 | 🐛 36 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
  ...
  * [vk-bootstrap](https://github.com/charles-lunarg/vk-bootstrap) ⭐ 1,276 | 🐛 27 | 🌐 C++ | 📅 2026-08-26 - C++ utility library to jump start Vulkan development by automating instance, physical device, device, and swapchain creation. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,432 | 🐛 284 | 🌐 C++ | 📅 2026-08-26 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,432 | 🐛 284 | 🌐 C++ | 📅 2026-08-26]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,284 | 🐛 760 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,284 | 🐛 760 | 🌐 C | 📅 2026-08-04]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,414 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,218 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,018 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 2 | 🌐 C++ | 📅 2026-08-24 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [Nabla](https://github.com/Devsh-Graphics-Programming/Nabla) ⭐ 712 | 🐛 121 | 🌐 C++ | 📅 2026-08-25 - Vulkan, OptiX and CUDA Interoperation Modular Rendering Library and Framework for PC/Linux/Android. \[Apache License 2.0]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,802 | 🐛 331 | 🌐 Objective-C++ | 📅 2026-08-25 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 916 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 726 | 🐛 87 | 🌐 LLVM | 📅 2026-08-25 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 806 | 🐛 4 | 🌐 C | 📅 2026-08-22 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,567 | 🐛 403 | 🌐 C++ | 📅 2026-08-24 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,492 | 🐛 154 | 🌐 GLSL | 📅 2026-07-31 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,172 | 🐛 103 | 🌐 C# | 📅 2026-08-25 - C# bindings for Vulkan and others. \[MIT]
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,142 | 🐛 89 | 🌐 Rust | 📅 2026-07-30 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,782 | 🐛 27 | 🌐 C++ | 📅 2026-08-25 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,331 | 🐛 78 | 🌐 Rust | 📅 2026-08-12 - Vulkan bindings for Rust. \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 225 | 🐛 13 | 🌐 Pascal | 📅 2026-08-25 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,014 | 🐛 50 | 🌐 C++ | 📅 2026-08-25 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,977 | 🐛 325 | 🌐 C | 📅 2026-08-25 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 770 | 🐛 50 | 🌐 C++ | 📅 2026-08-06 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,949 | 🐛 106 | 📅 2026-08-21 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,195 | 🐛 13 | 🌐 Markdown | 📅 2026-08-25 - Awesome list about game development.
