...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,253 | 🐛 31 | 🌐 C | 📅 2026-08-19 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,116 | 🐛 17 | 🌐 GLSL | 📅 2026-08-18 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,351 | 🐛 62 | 🌐 C++ | 📅 2026-08-18 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,351 | 🐛 62 | 🌐 C++ | 📅 2026-08-18]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,253 | 🐛 31 | 🌐 C | 📅 2026-08-19.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,712 | 🐛 1,234 | 🌐 C++ | 📅 2026-08-18 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,886 | 🐛 51 | 🌐 C++ | 📅 2026-08-19, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,886 | 🐛 51 | 🌐 C++ | 📅 2026-08-19. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,712 | 🐛 1,230 | 🌐 C++ | 📅 2026-08-18 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  ...
  * [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 340 | 🐛 7 | 🌐 Rust | 📅 2026-08-17 - An easy-to-use Vulkan render graph for Rust. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,409 | 🐛 288 | 🌐 C | 📅 2026-08-18 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,409 | 🐛 288 | 🌐 C | 📅 2026-08-18]
  ...
  * [Cinder](https://github.com/cinder/Cinder) ⭐ 5,532 | 🐛 360 | 🌐 C++ | 📅 2026-03-20 and [the story](https://libcinder.org/notes/vulkan) [behind](https://forum.libcinder.org/#Topic/23286000002614007). \[BSD]
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,400 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,215 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,017 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,918 | 🐛 2 | 🌐 C++ | 📅 2026-08-18 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [Auto-Vk-Toolkit](https://github.com/cg-tuwien/Auto-Vk-Toolkit) ⭐ 446 | 🐛 67 | 🌐 C++ | 📅 2025-10-17 - C++ framework around [Auto-Vk](https://github.com/cg-tuwien/Auto-Vk) ⭐ 300 | 🐛 30 | 🌐 C++ | 📅 2025-10-17 for rapid prototyping, research, and teaching, by the Research Unit of Computer Graphics, TU Wien. \[MIT for the framework's code]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,793 | 🐛 330 | 🌐 Objective-C++ | 📅 2026-08-17 - run Vulkan on iOS and macOS. \[Apache-2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 804 | 🐛 5 | 🌐 C | 📅 2026-08-18 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,564 | 🐛 404 | 🌐 C++ | 📅 2026-08-18 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,488 | 🐛 151 | 🌐 GLSL | 📅 2026-07-31 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,777 | 🐛 23 | 🌐 C++ | 📅 2026-08-18 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 899 | 🐛 24 | 🌐 Zig | 📅 2026-08-18 - Vulkan binding generator for Zig \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 224 | 🐛 13 | 🌐 Pascal | 📅 2026-08-19 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,989 | 🐛 49 | 🌐 C++ | 📅 2026-08-18 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,943 | 🐛 315 | 🌐 C | 📅 2026-08-18 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 768 | 🐛 49 | 🌐 C++ | 📅 2026-08-06 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,450 | 🐛 102 | 📅 2026-08-18 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,149 | 🐛 12 | 🌐 Markdown | 📅 2026-08-17 - Awesome list about game development.
