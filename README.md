...
A curated list of awesome Vulkan libraries, debuggers and resources. Inspired by [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,435 | 🐛 0 | 📅 2026-01-09 and other awesome-... stuff.
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,259 | 🐛 30 | 🌐 C | 📅 2026-08-24 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,126 | 🐛 17 | 🌐 GLSL | 📅 2026-08-18 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,360 | 🐛 64 | 🌐 C++ | 📅 2026-08-18 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,360 | 🐛 64 | 🌐 C++ | 📅 2026-08-18]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,259 | 🐛 30 | 🌐 C | 📅 2026-08-24.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,842 | 🐛 1,234 | 🌐 C++ | 📅 2026-08-23 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,901 | 🐛 50 | 🌐 C++ | 📅 2026-08-24, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,901 | 🐛 50 | 🌐 C++ | 📅 2026-08-24. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,738 | 🐛 1,234 | 🌐 C++ | 📅 2026-08-18 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,429 | 🐛 284 | 🌐 C++ | 📅 2026-08-23 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,429 | 🐛 284 | 🌐 C++ | 📅 2026-08-23]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,275 | 🐛 760 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,275 | 🐛 760 | 🌐 C | 📅 2026-08-04]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,410 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  ...
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,921 | 🐛 2 | 🌐 C++ | 📅 2026-08-24 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,800 | 🐛 331 | 🌐 Objective-C++ | 📅 2026-08-19 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 916 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 726 | 🐛 90 | 🌐 LLVM | 📅 2026-08-21 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,566 | 🐛 408 | 🌐 C++ | 📅 2026-08-24 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,490 | 🐛 152 | 🌐 GLSL | 📅 2026-07-31 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,780 | 🐛 26 | 🌐 C++ | 📅 2026-08-24 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,330 | 🐛 78 | 🌐 Rust | 📅 2026-08-12 - Vulkan bindings for Rust. \[MIT]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,007 | 🐛 49 | 🌐 C++ | 📅 2026-08-20 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,968 | 🐛 321 | 🌐 C | 📅 2026-08-18 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,508 | 🐛 106 | 📅 2026-08-21 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,191 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17 - Awesome list about game development.
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,435 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources.
