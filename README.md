...
* [AMD](http://www.amd.com/en-gb/innovations/software-technologies/technologies-gaming/vulkan)
  * [Open-source Driver](https://github.com/GPUOpen-Drivers/AMDVLK) ⭐ 1,976 | 🐛 28 | 📅 2025-09-15
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,285 | 🐛 27 | 🌐 C | 📅 2026-09-21 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [Linux port of SteamVR](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,070 | 🐛 453 | 📅 2026-06-06 - SteamVR is built on top of the Vulkan API.
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 829 | 🐛 1,040 | 🌐 C++ | 📅 2026-09-20 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 829 | 🐛 1,040 | 🌐 C++ | 📅 2026-09-20. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 829 | 🐛 1,040 | 🌐 C++ | 📅 2026-09-20 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,151 | 🐛 16 | 🌐 GLSL | 📅 2026-09-20 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,378 | 🐛 63 | 🌐 C++ | 📅 2026-09-19 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,378 | 🐛 63 | 🌐 C++ | 📅 2026-09-19]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,285 | 🐛 27 | 🌐 C | 📅 2026-09-21.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 76,296 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-18 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,945 | 🐛 50 | 🌐 C++ | 📅 2026-09-21, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,945 | 🐛 50 | 🌐 C++ | 📅 2026-09-21. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,848 | 🐛 1,203 | 🌐 C++ | 📅 2026-09-21 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,504 | 🐛 38 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
  ...
  * [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 344 | 🐛 6 | 🌐 Rust | 📅 2026-09-14 - An easy-to-use Vulkan render graph for Rust. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,495 | 🐛 284 | 🌐 C++ | 📅 2026-09-19 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,495 | 🐛 284 | 🌐 C++ | 📅 2026-09-19]
  ...
  * [The-Forge](https://github.com/ConfettiFX/The-Forge) ⭐ 5,660 | 🐛 14 | 🌐 C++ | 📅 2026-08-27 - DirectX 12, Vulkan, macOS Metal 2 rendering framework. \[Apache License 2.0]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,445 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-15 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,233 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  ...
  * [DemoFramework](https://github.com/NXPmicro/gtec-demo-framework) ⭐ 334 | 🐛 18 | 🌐 C++ | 📅 2026-09-18 - NXP GTEC C++11 cross-platform demo framework including lots of samples for Vulkan, OpenGL ES, OpenVX, OpenCL, OpenVG and OpenCV. \[[BSD-3-clause](https://github.com/NXPmicro/gtec-demo-framework/blob/master/License.md) ⭐ 334 | 🐛 18 | 🌐 C++ | 📅 2026-09-18]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 808 | 🐛 1 | 🌐 C | 📅 2026-09-20 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,203 | 🐛 103 | 🌐 C# | 📅 2026-09-08 - C# bindings for Vulkan and others. \[MIT]
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,152 | 🐛 89 | 🌐 Rust | 📅 2026-09-18 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,796 | 🐛 29 | 🌐 C++ | 📅 2026-09-19 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 227 | 🐛 13 | 🌐 Pascal | 📅 2026-09-21 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,107 | 🐛 50 | 🌐 C++ | 📅 2026-09-18 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,056 | 🐛 338 | 🌐 C | 📅 2026-09-16 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [Conformance Tests (CTS)](https://github.com/KhronosGroup/Vulkan-CTS) ⭐ 636 | 🐛 86 | 🌐 C++ | 📅 2026-09-18
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,333 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,339 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
...
Please see [CONTRIBUTING](https://github.com/vinjn/awesome-vulkan/blob/master/CONTRIBUTING.md) ⭐ 3,717 | 🐛 6 | 📅 2026-05-11 for details.
