...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,258 | 🐛 32 | 🌐 C | 📅 2026-08-22 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 816 | 🐛 997 | 🌐 C++ | 📅 2026-08-22 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 816 | 🐛 997 | 🌐 C++ | 📅 2026-08-22. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 816 | 🐛 997 | 🌐 C++ | 📅 2026-08-22 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,122 | 🐛 17 | 🌐 GLSL | 📅 2026-08-18 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
...
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,258 | 🐛 32 | 🌐 C | 📅 2026-08-22.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,817 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19 - Immediate Mode Graphical User interface. \[MIT]
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,731 | 🐛 1,233 | 🌐 C++ | 📅 2026-08-18 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,427 | 🐛 285 | 🌐 C++ | 📅 2026-08-23 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,427 | 🐛 285 | 🌐 C++ | 📅 2026-08-23]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,271 | 🐛 760 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,271 | 🐛 760 | 🌐 C | 📅 2026-08-04]
  * [The-Forge](https://github.com/ConfettiFX/The-Forge) ⭐ 5,641 | 🐛 14 | 🌐 C++ | 📅 2025-07-03 - DirectX 12, Vulkan, macOS Metal 2 rendering framework. \[Apache License 2.0]
  * [Cinder](https://github.com/cinder/Cinder) ⭐ 5,535 | 🐛 360 | 🌐 C++ | 📅 2026-03-20 and [the story](https://libcinder.org/notes/vulkan) [behind](https://forum.libcinder.org/#Topic/23286000002614007). \[BSD]
  ...
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,217 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,018 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,920 | 🐛 2 | 🌐 C++ | 📅 2026-08-22 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,796 | 🐛 331 | 🌐 Objective-C++ | 📅 2026-08-19 - run Vulkan on iOS and macOS. \[Apache-2.0]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,167 | 🐛 103 | 🌐 C# | 📅 2026-08-22 - C# bindings for Vulkan and others. \[MIT]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,779 | 🐛 27 | 🌐 C++ | 📅 2026-08-20 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,329 | 🐛 78 | 🌐 Rust | 📅 2026-08-12 - Vulkan bindings for Rust. \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 225 | 🐛 13 | 🌐 Pascal | 📅 2026-08-23 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,005 | 🐛 49 | 🌐 C++ | 📅 2026-08-20 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,956 | 🐛 320 | 🌐 C | 📅 2026-08-18 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 769 | 🐛 50 | 🌐 C++ | 📅 2026-08-06 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,007 | 🐛 106 | 📅 2026-08-21 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,180 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17 - Awesome list about game development.
