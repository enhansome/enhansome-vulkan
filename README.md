...
* Khronos
  * [Vulkan Guide](https://github.com/KhronosGroup/Vulkan-Guide) ⭐ 2,286 | 🐛 6 | 🌐 Makefile | 📅 2026-07-27
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,266 | 🐛 28 | 🌐 C | 📅 2026-09-03 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,367 | 🐛 65 | 🌐 C++ | 📅 2026-09-01 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,367 | 🐛 65 | 🌐 C++ | 📅 2026-09-01]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,266 | 🐛 28 | 🌐 C | 📅 2026-09-03.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 76,052 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-03 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,913 | 🐛 50 | 🌐 C++ | 📅 2026-09-04, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,913 | 🐛 50 | 🌐 C++ | 📅 2026-09-04. \[BSD 3-clause] [website](https://skia.org)
  * [VKVG](https://github.com/jpbruyere/vkvg) ⭐ 816 | 🐛 38 | 🌐 C | 📅 2026-09-03 - Vulkan 2D graphics library, API follows the same pattern as Cairo graphics lib, but with new functions.

* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,784 | 🐛 1,245 | 🌐 C++ | 📅 2026-09-02 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
  ...
  * [VkFFT](https://github.com/DTolm/VkFFT) ⭐ 1,771 | 🐛 100 | 🌐 C++ | 📅 2026-04-04 - Efficient Vulkan FFT library \[MPL-2.0 License]
...
* Low Level
  ...
  * [vk-bootstrap](https://github.com/charles-lunarg/vk-bootstrap) ⭐ 1,275 | 🐛 23 | 🌐 C++ | 📅 2026-09-01 - C++ utility library to jump start Vulkan development by automating instance, physical device, device, and swapchain creation. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,455 | 🐛 287 | 🌐 C++ | 📅 2026-09-04 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,455 | 🐛 287 | 🌐 C++ | 📅 2026-09-04]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,308 | 🐛 766 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,308 | 🐛 766 | 🌐 C | 📅 2026-08-04]
  ...
  * [Cinder](https://github.com/cinder/Cinder) ⭐ 5,538 | 🐛 360 | 🌐 C++ | 📅 2026-03-20 and [the story](https://libcinder.org/notes/vulkan) [behind](https://forum.libcinder.org/#Topic/23286000002614007). \[BSD]
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,425 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-01 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,223 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,021 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,922 | 🐛 3 | 🌐 C++ | 📅 2026-09-02 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,816 | 🐛 338 | 🌐 Objective-C++ | 📅 2026-08-25 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 916 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 727 | 🐛 63 | 🌐 LLVM | 📅 2026-09-03 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,571 | 🐛 406 | 🌐 C++ | 📅 2026-09-03 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,502 | 🐛 148 | 🌐 GLSL | 📅 2026-09-03 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,192 | 🐛 103 | 🌐 C# | 📅 2026-08-30 - C# bindings for Vulkan and others. \[MIT]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,785 | 🐛 27 | 🌐 C++ | 📅 2026-09-03 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,335 | 🐛 78 | 🌐 Rust | 📅 2026-08-28 - Vulkan bindings for Rust. \[MIT]
* [nvk](https://github.com/maierfelix/nvk) ⭐ 947 | 🐛 6 | 🌐 C++ | 📅 2021-01-03 - JavaScript bindings for Vulkan. \[MIT]
* [vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 906 | 🐛 24 | 🌐 Zig | 📅 2026-08-30 - Vulkan binding generator for Zig \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 225 | 🐛 13 | 🌐 Pascal | 📅 2026-09-04 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,054 | 🐛 49 | 🌐 C++ | 📅 2026-09-03 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,998 | 🐛 329 | 🌐 C | 📅 2026-08-25 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [Conformance Tests (CTS)](https://github.com/KhronosGroup/Vulkan-CTS) ⭐ 629 | 🐛 87 | 🌐 C++ | 📅 2026-08-28
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,776 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,247 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - Awesome list about game development.
