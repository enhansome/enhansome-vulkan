...
A curated list of awesome Vulkan libraries, debuggers and resources. Inspired by [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,443 | 🐛 0 | 📅 2026-01-09 and other awesome-... stuff.
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,286 | 🐛 27 | 🌐 C | 📅 2026-09-21 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [vkQuake2](https://github.com/kondrak/vkQuake2) ⭐ 1,012 | 🐛 2 | 🌐 C | 📅 2026-08-26 - id Software's Quake 2 v3.21 with Vulkan support (Windows and Linux). \[GPL]
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 829 | 🐛 1,043 | 🌐 C++ | 📅 2026-09-21 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 829 | 🐛 1,043 | 🌐 C++ | 📅 2026-09-21. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 829 | 🐛 1,043 | 🌐 C++ | 📅 2026-09-21 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,152 | 🐛 16 | 🌐 GLSL | 📅 2026-09-20 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,379 | 🐛 58 | 🌐 C++ | 📅 2026-09-21 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,379 | 🐛 58 | 🌐 C++ | 📅 2026-09-21]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,286 | 🐛 27 | 🌐 C | 📅 2026-09-21.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 76,307 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-21 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,950 | 🐛 50 | 🌐 C++ | 📅 2026-09-22, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,950 | 🐛 50 | 🌐 C++ | 📅 2026-09-22. \[BSD 3-clause] [website](https://skia.org)
  * [VKVG](https://github.com/jpbruyere/vkvg) ⭐ 819 | 🐛 43 | 🌐 C | 📅 2026-09-22 - Vulkan 2D graphics library, API follows the same pattern as Cairo graphics lib, but with new functions.

* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,855 | 🐛 1,205 | 🌐 C++ | 📅 2026-09-21 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
  * [Vulkan Kompute](https://github.com/axsaucedo/vulkan-kompute) ⭐ 2,571 | 🐛 79 | 🌐 C++ | 📅 2026-08-15 - Blazing fast and lightweight Vulkan Compute Framework optimized for advanced GPU processing usecases. \[Apache License 2.0]
  * [VkFFT](https://github.com/DTolm/VkFFT) ⭐ 1,777 | 🐛 101 | 🌐 C++ | 📅 2026-04-04 - Efficient Vulkan FFT library \[MPL-2.0 License]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,503 | 🐛 38 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
  ...
  * [vk-bootstrap](https://github.com/charles-lunarg/vk-bootstrap) ⭐ 1,286 | 🐛 23 | 🌐 C++ | 📅 2026-09-22 - C++ utility library to jump start Vulkan development by automating instance, physical device, device, and swapchain creation. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  ...
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,348 | 🐛 772 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,348 | 🐛 772 | 🌐 C | 📅 2026-08-04]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,446 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-22 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,234 | 🐛 65 | 🌐 C++ | 📅 2026-09-21 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,026 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,928 | 🐛 2 | 🌐 C++ | 📅 2026-09-20 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [PowerVR SDK](https://github.com/powervr-graphics/Native_SDK) ⭐ 773 | 🐛 25 | 🌐 C++ | 📅 2026-09-17 - C++ cross-platform 3D graphics SDK to speed up development of Vulkan and GLES. \[[LICENSE](https://github.com/powervr-graphics/Native_SDK/blob/4.1/LICENSE_POWERVR_SDK.txt) ⭐ 773 | 🐛 25 | 🌐 C++ | 📅 2026-09-17]
  * [Nabla](https://github.com/Devsh-Graphics-Programming/Nabla) ⭐ 717 | 🐛 121 | 🌐 C++ | 📅 2026-09-22 - Vulkan, OptiX and CUDA Interoperation Modular Rendering Library and Framework for PC/Linux/Android. \[Apache License 2.0]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,839 | 🐛 348 | 🌐 Objective-C++ | 📅 2026-09-21 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 917 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 729 | 🐛 63 | 🌐 LLVM | 📅 2026-09-21 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 809 | 🐛 1 | 🌐 C | 📅 2026-09-21 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,586 | 🐛 404 | 🌐 C++ | 📅 2026-09-21 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,516 | 🐛 147 | 🌐 GLSL | 📅 2026-09-21 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,203 | 🐛 104 | 🌐 C# | 📅 2026-09-22 - C# bindings for Vulkan and others. \[MIT]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,796 | 🐛 28 | 🌐 C++ | 📅 2026-09-21 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,345 | 🐛 79 | 🌐 Rust | 📅 2026-09-18 - Vulkan bindings for Rust. \[MIT]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,111 | 🐛 50 | 🌐 C++ | 📅 2026-09-21 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 776 | 🐛 49 | 🌐 C++ | 📅 2026-09-21 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [Conformance Tests (CTS)](https://github.com/KhronosGroup/Vulkan-CTS) ⭐ 636 | 🐛 87 | 🌐 C++ | 📅 2026-09-21
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,722 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,341 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,443 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources.
