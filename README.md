...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,272 | 🐛 27 | 🌐 C | 📅 2026-09-09 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [Linux port of SteamVR](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,065 | 🐛 441 | 📅 2026-06-06 - SteamVR is built on top of the Vulkan API.
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 823 | 🐛 1,028 | 🌐 C++ | 📅 2026-09-09 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 823 | 🐛 1,028 | 🌐 C++ | 📅 2026-09-09. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 823 | 🐛 1,028 | 🌐 C++ | 📅 2026-09-09 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,143 | 🐛 17 | 🌐 GLSL | 📅 2026-08-28 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,366 | 🐛 67 | 🌐 C++ | 📅 2026-09-09 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,366 | 🐛 67 | 🌐 C++ | 📅 2026-09-09]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,272 | 🐛 27 | 🌐 C | 📅 2026-09-09.
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,799 | 🐛 1,245 | 🌐 C++ | 📅 2026-09-10 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
  * [Vulkan Kompute](https://github.com/axsaucedo/vulkan-kompute) ⭐ 2,559 | 🐛 79 | 🌐 C++ | 📅 2026-08-15 - Blazing fast and lightweight Vulkan Compute Framework optimized for advanced GPU processing usecases. \[Apache License 2.0]
  * [VkFFT](https://github.com/DTolm/VkFFT) ⭐ 1,773 | 🐛 101 | 🌐 C++ | 📅 2026-04-04 - Efficient Vulkan FFT library \[MPL-2.0 License]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,491 | 🐛 37 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,474 | 🐛 285 | 🌐 C++ | 📅 2026-09-09 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,474 | 🐛 285 | 🌐 C++ | 📅 2026-09-09]
  ...
  * [PowerVR SDK](https://github.com/powervr-graphics/Native_SDK) ⭐ 775 | 🐛 25 | 🌐 C++ | 📅 2026-09-02 - C++ cross-platform 3D graphics SDK to speed up development of Vulkan and GLES. \[[LICENSE](https://github.com/powervr-graphics/Native_SDK/blob/4.1/LICENSE_POWERVR_SDK.txt) ⭐ 775 | 🐛 25 | 🌐 C++ | 📅 2026-09-02]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,823 | 🐛 342 | 🌐 Objective-C++ | 📅 2026-09-05 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 917 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 728 | 🐛 64 | 🌐 LLVM | 📅 2026-09-08 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 806 | 🐛 4 | 🌐 C | 📅 2026-09-09 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,577 | 🐛 407 | 🌐 C++ | 📅 2026-09-09 - Library for compiling glsl to spirv \[BSD 3-Clause]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,197 | 🐛 103 | 🌐 C# | 📅 2026-09-08 - C# bindings for Vulkan and others. \[MIT]
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,151 | 🐛 89 | 🌐 Rust | 📅 2026-09-03 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
...
* [ash](https://github.com/MaikKlein/ash) ⭐ 2,341 | 🐛 78 | 🌐 Rust | 📅 2026-09-04 - Vulkan bindings for Rust. \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 226 | 🐛 13 | 🌐 Pascal | 📅 2026-09-09 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,072 | 🐛 49 | 🌐 C++ | 📅 2026-09-09 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,013 | 🐛 333 | 🌐 C | 📅 2026-09-08 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 771 | 🐛 49 | 🌐 C++ | 📅 2026-09-09 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,603 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,271 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - Awesome list about game development.
