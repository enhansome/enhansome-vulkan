...
* [AMD](http://www.amd.com/en-gb/innovations/software-technologies/technologies-gaming/vulkan)
  * [Open-source Driver](https://github.com/GPUOpen-Drivers/AMDVLK) ⭐ 1,974 | 🐛 26 | 📅 2025-09-15
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,251 | 🐛 32 | 🌐 C | 📅 2026-08-16 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 813 | 🐛 993 | 🌐 C++ | 📅 2026-08-16 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 813 | 🐛 993 | 🌐 C++ | 📅 2026-08-16. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 813 | 🐛 993 | 🌐 C++ | 📅 2026-08-16 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,114 | 🐛 18 | 🌐 GLSL | 📅 2026-08-16 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,350 | 🐛 61 | 🌐 C++ | 📅 2026-08-10 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,350 | 🐛 61 | 🌐 C++ | 📅 2026-08-10]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,251 | 🐛 32 | 🌐 C | 📅 2026-08-16.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,682 | 🐛 1,232 | 🌐 C++ | 📅 2026-08-07 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,882 | 🐛 51 | 🌐 C++ | 📅 2026-08-17, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,882 | 🐛 51 | 🌐 C++ | 📅 2026-08-17. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,702 | 🐛 1,222 | 🌐 C++ | 📅 2026-08-13 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
  ...
  * [VkFFT](https://github.com/DTolm/VkFFT) ⭐ 1,769 | 🐛 98 | 🌐 C++ | 📅 2026-04-04 - Efficient Vulkan FFT library \[MPL-2.0 License]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,405 | 🐛 288 | 🌐 C | 📅 2026-08-17 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,405 | 🐛 288 | 🌐 C | 📅 2026-08-17]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,257 | 🐛 759 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,257 | 🐛 759 | 🌐 C | 📅 2026-08-04]
  * [The-Forge](https://github.com/ConfettiFX/The-Forge) ⭐ 5,637 | 🐛 14 | 🌐 C++ | 📅 2025-07-03 - DirectX 12, Vulkan, macOS Metal 2 rendering framework. \[Apache License 2.0]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,396 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,213 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,018 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,919 | 🐛 2 | 🌐 C++ | 📅 2026-08-16 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [Nabla](https://github.com/Devsh-Graphics-Programming/Nabla) ⭐ 713 | 🐛 120 | 🌐 C++ | 📅 2026-08-13 - Vulkan, OptiX and CUDA Interoperation Modular Rendering Library and Framework for PC/Linux/Android. \[Apache License 2.0]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,789 | 🐛 329 | 🌐 Objective-C++ | 📅 2026-08-13 - run Vulkan on iOS and macOS. \[Apache-2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 804 | 🐛 4 | 🌐 C | 📅 2026-08-15 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  ...
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,487 | 🐛 150 | 🌐 GLSL | 📅 2026-07-31 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,138 | 🐛 87 | 🌐 Rust | 📅 2026-07-30 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
...
* [vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 898 | 🐛 24 | 🌐 Zig | 📅 2026-07-25 - Vulkan binding generator for Zig \[MIT]
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 223 | 🐛 13 | 🌐 Pascal | 📅 2026-08-16 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,981 | 🐛 50 | 🌐 C++ | 📅 2026-08-15 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,938 | 🐛 314 | 🌐 C | 📅 2026-08-08 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,604 | 🐛 100 | 📅 2026-06-30 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,140 | 🐛 12 | 🌐 Markdown | 📅 2026-08-16 - Awesome list about game development.
...
Please see [CONTRIBUTING](https://github.com/vinjn/awesome-vulkan/blob/master/CONTRIBUTING.md) ⭐ 3,716 | 🐛 5 | 📅 2026-05-11 for details.
