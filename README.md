...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,286 | 🐛 28 | 🌐 C | 📅 2026-09-23 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [Linux port of SteamVR](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,072 | 🐛 454 | 📅 2026-06-06 - SteamVR is built on top of the Vulkan API.
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,153 | 🐛 16 | 🌐 GLSL | 📅 2026-09-20 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,381 | 🐛 59 | 🌐 C++ | 📅 2026-09-21 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,381 | 🐛 59 | 🌐 C++ | 📅 2026-09-21]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,286 | 🐛 28 | 🌐 C | 📅 2026-09-23.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 76,323 | 🐛 1,225 | 🌐 C++ | 📅 2026-09-22 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,951 | 🐛 50 | 🌐 C++ | 📅 2026-09-23, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,951 | 🐛 50 | 🌐 C++ | 📅 2026-09-23. \[BSD 3-clause] [website](https://skia.org)
  * [VKVG](https://github.com/jpbruyere/vkvg) ⭐ 819 | 🐛 39 | 🌐 C | 📅 2026-09-22 - Vulkan 2D graphics library, API follows the same pattern as Cairo graphics lib, but with new functions.

* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,863 | 🐛 1,206 | 🌐 C++ | 📅 2026-09-23 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  ...
  * [Screen 13](https://github.com/attackgoat/screen-13) ⭐ 342 | 🐛 6 | 🌐 Rust | 📅 2026-09-22 - An easy-to-use Vulkan render graph for Rust. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  ...
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,352 | 🐛 773 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,352 | 🐛 773 | 🌐 C | 📅 2026-08-04]
  ...
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,928 | 🐛 2 | 🌐 C++ | 📅 2026-09-22 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [PowerVR SDK](https://github.com/powervr-graphics/Native_SDK) ⭐ 774 | 🐛 25 | 🌐 C++ | 📅 2026-09-22 - C++ cross-platform 3D graphics SDK to speed up development of Vulkan and GLES. \[[LICENSE](https://github.com/powervr-graphics/Native_SDK/blob/4.1/LICENSE_POWERVR_SDK.txt) ⭐ 774 | 🐛 25 | 🌐 C++ | 📅 2026-09-22]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,840 | 🐛 348 | 🌐 Objective-C++ | 📅 2026-09-21 - run Vulkan on iOS and macOS. \[Apache-2.0]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,586 | 🐛 404 | 🌐 C++ | 📅 2026-09-22 - Library for compiling glsl to spirv \[BSD 3-Clause]
...
* [Silk.NET](https://github.com/dotnet/Silk.NET) ⭐ 5,205 | 🐛 105 | 🌐 C# | 📅 2026-09-23 - C# bindings for Vulkan and others. \[MIT]
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,152 | 🐛 87 | 🌐 Rust | 📅 2026-09-22 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,796 | 🐛 30 | 🌐 C++ | 📅 2026-09-22 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,113 | 🐛 51 | 🌐 C++ | 📅 2026-09-22 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,059 | 🐛 338 | 🌐 C | 📅 2026-09-16 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,102 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,349 | 🐛 16 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
