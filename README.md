...
* [Tutorial by Overv](https://vulkan-tutorial.com/) and [its github repository](https://github.com/Overv/VulkanTutorial) ⭐ 3,689 | 🐛 76 | 🌐 C++ | 📅 2026-05-18. \[CC BY-SA 4.0]
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,281 | 🐛 28 | 🌐 C | 📅 2026-09-16 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [Linux port of SteamVR](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,069 | 🐛 449 | 📅 2026-06-06 - SteamVR is built on top of the Vulkan API.
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 828 | 🐛 1,038 | 🌐 C++ | 📅 2026-09-17 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 828 | 🐛 1,038 | 🌐 C++ | 📅 2026-09-17. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 828 | 🐛 1,038 | 🌐 C++ | 📅 2026-09-17 [website](https://ddnet.tw/)
...
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,375 | 🐛 63 | 🌐 C++ | 📅 2026-09-17 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,375 | 🐛 63 | 🌐 C++ | 📅 2026-09-17]
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,281 | 🐛 28 | 🌐 C | 📅 2026-09-16.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 76,235 | 🐛 1,228 | 🌐 C++ | 📅 2026-09-17 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,935 | 🐛 50 | 🌐 C++ | 📅 2026-09-18, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,935 | 🐛 50 | 🌐 C++ | 📅 2026-09-18. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,835 | 🐛 1,208 | 🌐 C++ | 📅 2026-09-18 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,501 | 🐛 38 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
  ...
  * [vk-bootstrap](https://github.com/charles-lunarg/vk-bootstrap) ⭐ 1,285 | 🐛 23 | 🌐 C++ | 📅 2026-09-08 - C++ utility library to jump start Vulkan development by automating instance, physical device, device, and swapchain creation. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,491 | 🐛 284 | 🌐 C++ | 📅 2026-09-18 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,491 | 🐛 284 | 🌐 C++ | 📅 2026-09-18]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,341 | 🐛 772 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,341 | 🐛 772 | 🌐 C | 📅 2026-08-04]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,440 | 🐛 24 | 🌐 Batchfile | 📅 2026-09-15 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  ...
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,925 | 🐛 3 | 🌐 C++ | 📅 2026-09-17 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
  ...
  * [Nabla](https://github.com/Devsh-Graphics-Programming/Nabla) ⭐ 716 | 🐛 120 | 🌐 C++ | 📅 2026-09-18 - Vulkan, OptiX and CUDA Interoperation Modular Rendering Library and Framework for PC/Linux/Android. \[Apache License 2.0]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,832 | 🐛 345 | 🌐 Objective-C++ | 📅 2026-09-05 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 917 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 730 | 🐛 63 | 🌐 LLVM | 📅 2026-09-15 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 808 | 🐛 2 | 🌐 C | 📅 2026-09-17 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,587 | 🐛 402 | 🌐 C++ | 📅 2026-09-17 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,515 | 🐛 146 | 🌐 GLSL | 📅 2026-09-17 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,794 | 🐛 28 | 🌐 C++ | 📅 2026-09-17 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 11,095 | 🐛 51 | 🌐 C++ | 📅 2026-09-17 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 9,041 | 🐛 336 | 🌐 C | 📅 2026-09-16 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [VulkanTools](https://github.com/LunarG/VulkanTools) ⭐ 775 | 🐛 49 | 🌐 C++ | 📅 2026-09-10 - LunarG's tools including layers and configurator. \[Apache Licence 2.0]
...
* [Conformance Tests (CTS)](https://github.com/KhronosGroup/Vulkan-CTS) ⭐ 634 | 🐛 85 | 🌐 C++ | 📅 2026-09-12
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,239 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,324 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
