...
A curated list of awesome Vulkan libraries, debuggers and resources. Inspired by [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,433 | 🐛 0 | 📅 2026-01-09 and other awesome-... stuff.
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,118 | 🐛 17 | 🌐 GLSL | 📅 2026-08-18 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
* Khronos [Vulkan samples](https://github.com/KhronosGroup/Vulkan-Samples) ⭐ 5,356 | 🐛 63 | 🌐 C++ | 📅 2026-08-18 \[[LICENSE](https://github.com/KhronosGroup/Vulkan-Samples/blob/master/LICENSE) ⭐ 5,356 | 🐛 63 | 🌐 C++ | 📅 2026-08-18]
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,744 | 🐛 1,235 | 🌐 C++ | 📅 2026-08-19 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,888 | 🐛 50 | 🌐 C++ | 📅 2026-08-20, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,888 | 🐛 50 | 🌐 C++ | 📅 2026-08-20. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,717 | 🐛 1,230 | 🌐 C++ | 📅 2026-08-18 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
...
* Low Level
  * [Vulkan Memory Allocator](https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator) ⭐ 3,469 | 🐛 35 | 🌐 C | 📅 2026-06-04 - Easy to integrate Vulkan memory allocation library from AMD. \[MIT]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,414 | 🐛 287 | 🌐 C++ | 📅 2026-08-19 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,414 | 🐛 287 | 🌐 C++ | 📅 2026-08-19]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,262 | 🐛 760 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,262 | 🐛 760 | 🌐 C | 📅 2026-08-04]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,401 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-16 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  ...
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,919 | 🐛 2 | 🌐 C++ | 📅 2026-08-19 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
...
* Other API Interop and Implementations
  * [MoltenVK](https://github.com/KhronosGroup/MoltenVK/) ⭐ 5,794 | 🐛 330 | 🌐 Objective-C++ | 📅 2026-08-19 - run Vulkan on iOS and macOS. \[Apache-2.0]
  * [VUDA](https://github.com/jgbit/vuda) ⭐ 916 | 🐛 7 | 🌐 C++ | 📅 2024-01-21 - header-only lib that provides a CUDA Runtime API interface. \[MIT]
  * [clspv](https://github.com/google/clspv) ⭐ 725 | 🐛 89 | 🌐 LLVM | 📅 2026-08-19 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,564 | 🐛 403 | 🌐 C++ | 📅 2026-08-18 - Library for compiling glsl to spirv \[BSD 3-Clause]
...
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,778 | 🐛 25 | 🌐 C++ | 📅 2026-08-19 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [vulkan-zig](https://github.com/Snektron/vulkan-zig) ⭐ 900 | 🐛 24 | 🌐 Zig | 📅 2026-08-18 - Vulkan binding generator for Zig \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,945 | 🐛 315 | 🌐 C | 📅 2026-08-18 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,849 | 🐛 103 | 📅 2026-08-18 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,155 | 🐛 13 | 🌐 Markdown | 📅 2026-08-17 - Awesome list about game development.
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,433 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources.
