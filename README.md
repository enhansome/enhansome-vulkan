...
* [Tutorial by Overv](https://vulkan-tutorial.com/) and [its github repository](https://github.com/Overv/VulkanTutorial) ⭐ 3,681 | 🐛 76 | 🌐 C++ | 📅 2026-05-18. \[CC BY-SA 4.0]
...
* [vkQuake](https://github.com/Novum/vkQuake) ⭐ 2,246 | 🐛 36 | 🌐 C | 📅 2026-08-08 - Vulkan Quake port based on QuakeSpasm. \[GPL]
...
* [Linux port of SteamVR](https://github.com/ValveSoftware/SteamVR-for-Linux) ⭐ 1,064 | 🐛 436 | 📅 2026-06-06 - SteamVR is built on top of the Vulkan API.
...
* [DDraceNetwork](https://github.com/ddnet/ddnet/) ⭐ 813 | 🐛 982 | 🌐 C++ | 📅 2026-08-13 - Cooperative 2D platformer with optional [Vulkan backend](https://github.com/ddnet/ddnet/blob/master/src/engine/client/backend/vulkan/backend_vulkan.cpp) ⭐ 813 | 🐛 982 | 🌐 C++ | 📅 2026-08-13. - [zlib](https://github.com/ddnet/ddnet/blob/master/license.txt) ⭐ 813 | 🐛 982 | 🌐 C++ | 📅 2026-08-13 [website](https://ddnet.tw/)
...
* Sascha Willems's [samples](https://github.com/SaschaWillems/Vulkan) ⭐ 12,105 | 🐛 18 | 🌐 GLSL | 📅 2026-08-08 and [Deferred rendering of Sponza](https://github.com/SaschaWillems/VulkanSponza) ⚠️ Archived and his talk of [Khronos\_meetup\_munich](https://www.saschawillems.de/blog/2016/04/11/khronos-chapter-munich-vulkan-slides/).
...
* [Vulkan Quake port based on QuakeSpasm](https://github.com/Novum/vkQuake) ⭐ 2,246 | 🐛 36 | 🌐 C | 📅 2026-08-08.
...
* 2D
  * [imgui](https://github.com/ocornut/imgui) ⭐ 75,644 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-07 - Immediate Mode Graphical User interface. \[MIT]
  * [Skia](https://skia.googlesource.com/skia) - Google's 2D graphics library has a [Vulkan](https://skia.org/user/special/vulkan) [backend](https://github.com/google/skia/tree/master/src/gpu/vk) ⭐ 10,875 | 🐛 51 | 🌐 C++ | 📅 2026-08-13, demonstrated in a cross-platform [sample application](https://skia.org/user/sample/viewer) with its own [window library](https://github.com/google/skia/tree/master/tools/viewer) ⭐ 10,875 | 🐛 51 | 🌐 C++ | 📅 2026-08-13. \[BSD 3-clause] [website](https://skia.org)
...
* Compute
  * [ncnn](https://github.com/Tencent/ncnn) ⭐ 23,694 | 🐛 1,216 | 🌐 C++ | 📅 2026-08-13 - High-performance neural network inference framework with Vulkan based GPU inference. \[BSD 3-clause]
  * [Vulkan Kompute](https://github.com/axsaucedo/vulkan-kompute) ⭐ 2,553 | 🐛 77 | 🌐 C++ | 📅 2026-07-26 - Blazing fast and lightweight Vulkan Compute Framework optimized for advanced GPU processing usecases. \[Apache License 2.0]
...
* Frameworks, Engines, Higher Level Rendering
  * [bgfx](https://github.com/bkaradzic/bgfx#bgfx---cross-platform-rendering-library) ⭐ 17,396 | 🐛 287 | 🌐 C | 📅 2026-08-14 - Cross-platform, graphics API agnostic, "Bring Your Own Engine/Framework" style rendering library. \[[BSD-2-clause](https://github.com/bkaradzic/bgfx/blob/master/LICENSE) ⭐ 17,396 | 🐛 287 | 🌐 C | 📅 2026-08-14]
  * [glfw](https://github.com/glfw/glfw) ⭐ 15,253 | 🐛 760 | 🌐 C | 📅 2026-08-04 and [the guide](http://www.glfw.org/docs/3.2/vulkan.html).  \[[LICENSE](https://github.com/glfw/glfw/blob/master/LICENSE.md) ⭐ 15,253 | 🐛 760 | 🌐 C | 📅 2026-08-04]
  * [The-Forge](https://github.com/ConfettiFX/The-Forge) ⭐ 5,633 | 🐛 14 | 🌐 C++ | 📅 2025-07-03 - DirectX 12, Vulkan, macOS Metal 2 rendering framework. \[Apache License 2.0]
  ...
  * [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,388 | 🐛 24 | 🌐 Batchfile | 📅 2026-08-12 - a modern cross-platform low-level graphics library that supports OpenGL/GLES, Direct3D11/12 and Vulkan. \[Apache License 2.0]
  * [Falcor](https://github.com/NVIDIAGameWorks/Falcor) ⭐ 3,212 | 🐛 65 | 🌐 C++ | 📅 2025-01-07 - Real-time rendering framework from NVIDIA, supporting mainly DX12, with experimental Vulkan support. \[BSD 3-clause]
  * [Acid](https://github.com/Equilibrium-Games/Acid) ⭐ 2,015 | 🐛 21 | 🌐 C++ | 📅 2023-09-21 - A high speed C++17 Vulkan game engine. \[MIT]
  * [bsf](https://github.com/GameFoundry/bsf) ⭐ 1,920 | 🐛 2 | 🌐 C++ | 📅 2026-08-13 - Modern C++14 library for the development of real-time graphical applications. \[MIT]
...
* Other API Interop and Implementations
  ...
  * [clspv](https://github.com/google/clspv) ⭐ 725 | 🐛 89 | 🌐 LLVM | 📅 2026-08-10 - prototype compiler for a subset of OpenCL C to Vulkan compute shaders. \[Apache License 2.0]
...
* Scientific
  * [datoviz](https://github.com/datoviz/datoviz) ⭐ 803 | 🐛 5 | 🌐 C | 📅 2026-08-13 - High-performance GPU interactive scientific data visualization with Vulkan. \[MIT]
...
* Shaders
  * [glslang](https://github.com/KhronosGroup/glslang) ⭐ 3,562 | 🐛 407 | 🌐 C++ | 📅 2026-08-13 - Library for compiling glsl to spirv \[BSD 3-Clause]
  * [SPIRV-Cross](https://github.com/KhronosGroup/SPIRV-Cross) ⭐ 2,485 | 🐛 150 | 🌐 GLSL | 📅 2026-07-31 - Library for reflection of spirv, simplify the creation of Vulkan pipeline layouts \[ Apache-2.0 License]
...
* [Vulkano](https://github.com/vulkano-rs/vulkano) ⭐ 5,140 | 🐛 87 | 🌐 Rust | 📅 2026-07-30 - Safe and rich Rust wrapper around the Vulkan API. \[MIT]
* [Vulkan-hpp](https://github.com/KhronosGroup/Vulkan-Hpp) ⭐ 3,778 | 🐛 23 | 🌐 C++ | 📅 2026-08-13 Open-Source Vulkan C++ API originated from NVIDIA and [the blog](https://developer.nvidia.com/open-source-vulkan-c-api) about it.
...
* [PasVulkan](https://github.com/BeRo1985/pasvulkan) ⭐ 223 | 🐛 13 | 🌐 Pascal | 📅 2026-08-13 - Vulkan bindings plus high-level wrapper library for Object Pascal \[Zlib]
...
* [renderdoc](https://github.com/baldurk/renderdoc) ⭐ 10,969 | 🐛 50 | 🌐 C++ | 📅 2026-08-13 - by baldurk, a stand-alone graphics debugging tool. \[MIT]
...
* [MangoHud](https://github.com/flightlessmango/MangoHud) ⭐ 8,932 | 🐛 313 | 🌐 C | 📅 2026-08-08 - Vulkan and OpenGL overlay for monitoring FPS, temperatures, CPU/GPU load. \[MIT]
...
* [Conformance Tests (CTS)](https://github.com/KhronosGroup/Vulkan-CTS) ⭐ 628 | 🐛 86 | 🌐 C++ | 📅 2026-08-09
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,448 | 🐛 99 | 📅 2026-06-30 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,122 | 🐛 12 | 🌐 Markdown | 📅 2026-08-10 - Awesome list about game development.
